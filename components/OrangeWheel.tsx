    ...
    <div className="relative" style={{ width: size, height: size }}>
      <svg
        ...
        style={{
          ...
          transition: isSpinning ? 'none' : 'filter 0.3s',
      ...
      >
        ...
        {isEmpty ? (
          <>
            {/* Empty state - full orange */}
            <circle cx={cx} cy={cy} r={r} fill="#ff6b00" opacity="0.15" />
            {/* Segment lines for empty orange look */}
